...
ZIPNAME="/tmp/output/SunriseKernel-juice_$(date +%Y%m%d-%H%M).zip"
...
env() {
export TELEGRAM_BOT_TOKEN="5314671466:AAEh5nCOW6YDRRJRvXmNeMjSbP0GeOAwS9c"
...
export KBUILD_BUILD_HOST=SunriseCI
